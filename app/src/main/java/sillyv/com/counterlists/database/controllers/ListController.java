...
public class ListController {
    ...
    public ListController(Application application) {
        realm = Realm.getDefaultInstance();
    }

    public static ListController with(Fragment fragment) {

        if (instance == null) {
            instance = new ListController(fragment.getActivity().getApplication());
        }
        return instance;
    }

    public static ListController with(Activity activity) {

        if (instance == null) {
            instance = new ListController(activity.getApplication());
        }
        return instance;
    }

    public static ListController with(Application application) {

        if (instance == null) {
            instance = new ListController(application);
        }
        return instance;
    }
    ...
    public RealmResults<CounterList> getCounterLists() {
        ...
        return realm.where(CounterList.class).findAll();
    }
